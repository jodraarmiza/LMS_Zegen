...
const CourseSession: React.FC = () => {
  const { courseId, sessionId = "1" } = useParams<{
    courseId: string;
    sessionId?: string;
  }>();
  ...
  useEffect(() => {
    ...
    const mockSession: Session = {
      ...
      delivery: "Online",
      zoomLink:
        "https://us05web.zoom.us/j/85360480#?pwd=ZGdFUE0JMHRpSTUyUTllRzVlNML2.JCQTo9",
      contents: [
        {
          id: "c1",
          title: "Basic Concepts of ITSM",
          description:
            "ITSM (IT Service Management) adalah pendekatan strategis untuk merancang, mengelola, dan meningkatkan layanan TI agar selaras dengan kebutuhan bisnis.",
          duration: "30m",
          status: "Completed",
          progress: 100,
        },
        {
          ...
          description:
            "ITIL - Framework berbasis praktik terbaik untuk manajemen layanan TI dalam lima tahap: Strategy, Design, Transition, Operation, dan Improvement.",
          duration: "30m",
          status: "Completed",
          progress: 100,
        },
        {
          ...
          description:
            "COBIT - Framework untuk tata kelola dan manajemen TI, berfokus pada kontrol, risiko, dan kepatuhan.",
          duration: "30m",
          status: "Completed",
          progress: 100,
        },
        {
          ...
          title: "ISO 20000",
          description:
            "ISO 20000 - Standar internasional untuk ITSM yang membantu organisasi menerapkan layanan TI yang terstruktur dan efisien.",
          duration: "30m",
          status: "Completed",
          progress: 100,
        },
    ...
    const targetSessionItem = mockCourse.sessionList.find(
      (s) => s.id === sessionId
    );
  ...
  const navigateToSession = (sessionNumber: number) => {
    if (!course) return;
    const targetSession = course.sessionList.find(
      (s) => s.number === sessionNumber
    );
    if (targetSession) {
                  ...
                  <TabPanels>
                      ...
                      <Flex overflowY="hidden">
                        ...
                        >
                          ...
                          <Box mb={6}>
                            ...
                            <Text mb={2}>
                              ITSM (IT Service Management) adalah pendekatan
                              strategis untuk merancang, mengelola, dan
                              meningkatkan layanan TI agar selaras dengan
                              kebutuhan bisnis.
                            </Text>
                            ...
                            <Box pl={4}>
                              <Text mb={1}>
                                • ITIL - Framework berbasis praktik terbaik
                                untuk manajemen layanan TI dalam lima tahap:
                                Strategy, Design, Transition, Operation, dan
                                Improvement.
                              </Text>
                            </Box>
                            <Text fontWeight="medium" mt={4} mb={2}>
                            ...
                            <Box pl={4}>
                              <Text mb={1}>
                                • COBIT - Framework untuk tata kelola dan
                                manajemen TI, berfokus pada kontrol, risiko, dan
                                kepatuhan.
                              </Text>
                            </Box>
                            <Text fontWeight="medium" mt={4} mb={2}>
                            ...
                            <Box pl={4}>
                              <Text mb={1}>
                                • ISO 20000 - Standar internasional untuk ITSM
                                yang membantu organisasi menerapkan layanan TI
                          ...
                          <VStack spacing={0} align="stretch">
                            {course.sessionList.map((sessionItem) => (
                              <Box
                                ...
                                mb={1}
                                onClick={() =>
                                  navigateToSession(sessionItem.number)
                                }
                                cursor="pointer"
                                _hover={{ bg: "gray.50" }}
                              >
                                ...
                                >
                                  ...
                                  <Flex align="center">
                                    <Box
                                      ...
                                      borderRadius="full"
                                      bg={
                                        getStatusColor(sessionItem.status) +
                                        ".500"
                                      }
                                      mr={2}
                                    />
                    ...
                    <TabPanel>
                      <Box p={6}>
                        ...
                        <Text>
                          Assessment rubric content will be displayed here.
                        </Text>
                      </Box>
                    </TabPanel>

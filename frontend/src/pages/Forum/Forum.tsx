      ...
      instructors: [
        {
          id: "103",
          name: "Sarah Smith",
          avatarUrl: "https://placehold.co/32x32?text=SS",
        },
        {
          id: "104",
          name: "David Wong",
          avatarUrl: "https://placehold.co/32x32?text=DW",
        },
      ],
    },
    {
      ...
      instructors: [
        {
          id: "105",
          name: "Emily Johnson",
          avatarUrl: "https://placehold.co/32x32?text=EJ",
        },
        {
          id: "106",
          name: "Michael Chang",
          avatarUrl: "https://placehold.co/32x32?text=MC",
        },
        {
          id: "107",
          name: "Lisa Taylor",
          avatarUrl: "https://placehold.co/32x32?text=LT",
        },
      ],
    },
    {
      ...
      instructors: [
        {
          id: "108",
          name: "Robert Kim",
          avatarUrl: "https://placehold.co/32x32?text=RK",
        },
        {
          id: "109",
          name: "Sophia Lee",
          avatarUrl: "https://placehold.co/32x32?text=SL",
        },
        {
          id: "110",
          name: "James Wilson",
          avatarUrl: "https://placehold.co/32x32?text=JW",
        },
      ],
    },
  ];
